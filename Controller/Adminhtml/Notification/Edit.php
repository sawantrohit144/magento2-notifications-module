...
class Edit extends \Coditron\Notifications\Controller\Adminhtml\Notification
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('coditron_notifications_notification', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Notification %1', $model->getId()) : __('New Notification'));
        return $resultPage;
    }
}
